...
if __name__ == "__main__":
    ...
    from md_scenarionet import SCENARIONET_DATASET_PATH
    from md_scenarionet.converter.nuscenes.utils import convert_nuscenes_scenario, get_nuscenes_scenarios, \
        get_nuscenes_prediction_split
    from md_scenarionet.converter.utils import write_to_directory
    ...
    if version in scene_split:
        ...
        scenarios, nuscs = get_nuscenes_prediction_split( # each scenario is a token(instance_token, sample_token)
