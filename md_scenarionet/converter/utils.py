...
from md_scenarionet.builder.utils import merge_database
from md_scenarionet.common_utils import save_summary_and_mapping
...
def write_to_directory_single_worker(
    ...
    **kwargs
    ...
    for scenario in scenarios:
        # convert scenario
        sd_scenario = convert_func(scenario, dataset_version, **kwargs) # ArgoverseScenario -> ScenarioDescription
