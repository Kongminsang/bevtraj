...
from unitraj.models.bevtp.mtr.MTR_utils import PointNetPolylineEncoder, get_batch_offsets, build_mlps
from unitraj.models.bevtp.mtr.ops.knn import knn_utils
from unitraj.models.bevtp.mtr.transformer import transformer_encoder_layer

from unitraj.models.bevtp.linear import build_mlp
from unitraj.models.bevtp.bev_deformable_aggregation import BEVDeformableAggregation
from unitraj.models.bevtp.positional_encoding_utils import gen_sineembed_for_position


class BEVTPSceneContextEncoder(nn.Module):
    def __init__(self, config, pre_enc_dim, bev_feat_dim):
        super(BEVTPSceneContextEncoder, self).__init__()
        self.config = config
