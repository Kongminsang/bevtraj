...
from unitraj.models.bevtraj.bevfusion.mmengine_modules import BaseModule
from unitraj.models.bevtraj.bevfusion.data_preprocessors import Det3DDataPreprocessor
...
class BaseModel(BaseModule):
    ...
    def __init__(self,
        ...
        if isinstance(data_preprocessor, nn.Module):
            ...
            self.data_preprocessor = Det3DDataPreprocessor(**data_preprocessor)
        else:
