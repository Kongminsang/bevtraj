...
from unitraj.models.bevtraj.bevfusion.mmcv_modules import build_conv_layer, build_norm_layer
from unitraj.models.bevtraj.bevfusion.mmdet_modules import BasicBlock, Bottleneck
...
def make_sparse_convmodule(in_channels: int,
                           ...
                           conv_type: str = 'SubMConv3d', # SparseConv3d
